        ...
        <div x-data="{ open: false }" class="relative bg-white shadow">
            <div class="max-w-7xl mx-auto px-4 sm:px-6">
                <div class="flex justify-between items-center py-6 md:justify-start md:space-x-10">
                    ...
                    <nav x-show="open" class="flex space-x-10">

                        <a href="{{ url('/') }}" class="text-base font-medium text-gray-500 hover:text-gray-900">
                            Home
                        </a>

                        <a href="{{ url('/portfolio') }}" class="text-base font-medium text-gray-500 hover:text-gray-900">
                            Portfolio
                        </a>

                        <a href="{{ url('/pricing') }}" class="text-base font-medium text-gray-500 hover:text-gray-900">
                            Pricing
                        </a>
                    ...
                    <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                        <a href="{{ url('pricing') }}" class="ml-8 whitespace-nowrap inline-flex items-center justify-center
